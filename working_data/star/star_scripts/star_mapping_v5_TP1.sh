...
for i in /home/lombardi/HiSeq_1143/data/working_data/trimmed/trimmed_pe/TP-1-*_R1_trimmed_pe.fastq.gz; do
  ...
  STAR --runMode alignReads \
    ...
    --outFileNamePrefix /home/lombardi/HiSeq_1143/data/working_data/star/star_mapping_ouput/star_output_TP1/${Sample}_ \
